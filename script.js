...
//Umieszczenie wszystkich liter alfabetu w divach 'letter' i nadanie im oddzielnego id
	...
	password_output();	//Wykonanie funkcji ukrycia hasła
}
...
/* ===================================== MECHANIZM GRY  ===================================== */
function check(n) {//n to 'numer' litery sprawdzany w petli w funkcji start()
	var trafiona = false; //Boolean majacy potwierdzac czy litera znajduje sie w hasle
